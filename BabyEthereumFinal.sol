...
contract BabyEthereum is ERC20, Ownable {
    ...
    constructor() public ERC20("BABY ETHEREUM Test", "BET") {
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 2000000 && newValue <= 5000000, "BabyEthereum: gasForProcessing must be between 2,000,000 and 5,000,000");
